...
CORPUS_DISPLAY_NAME = "docs_corpus" # "Alphabet_10K_2024_corpus"
CORPUS_DESCRIPTION = "Corpus containing documents that AI agent can use to answer questions."
...
def main():
  ...
  for filename in os.listdir(data_dir):
      ...
      if os.path.isfile(local_file_path):
          # Use the filename as display name and description (you can modify this as needed)
          display_name = filename
          description = filename
          
          # Ensure the file exists before uploading (though we already checked with isfile)
  ...
  # update RAG_CORPUS in the .env file 
  update_env_file(corpus_name=corpus.name, env_file_path=ENV_FILE_PATH)
